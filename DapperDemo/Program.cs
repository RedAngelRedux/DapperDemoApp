...
// Use various methods to demonstrate Dapper functionality

//await SimulateSqlInjectionAttack(db);
//await SimpleDapperCall_RawSql(db);
//await SimpleDapperCall_StoredProcedure(db);
//await SimpleDapperCall_StoredProcedureWithParameter(db);
//await SimpleDapperCall_RawSql_UpdateLastName(db);
//await PreventSqlInjectionAttack(db);
//await DapperListSupport(db);
//await ReturnSingleRecord(db);
//await ReturnParameters(db);
await OutputParameters(db);


/// <summary>
/// Simply demonstrates how to use Dapper with raw SQL queries and stored procedures.
/// </summary>
static async Task SimpleDapperCall_RawSql(IDbConnection db)
{
...
static async Task SimpleDapperCall_StoredProcedure(IDbConnection db)
{
...
static async Task SimulateSqlInjectionAttack(IDbConnection db)
{    
...
static async Task PreventSqlInjectionAttack(IDbConnection db)
{
...
static async Task SimpleDapperCall_StoredProcedureWithParameter(IDbConnection db)
{
...
static async Task SimpleDapperCall_RawSql_UpdateLastName(IDbConnection db)
{
    Console.WriteLine("\nUpdate Last Name");
    Console.WriteLine("====================================\n");
...
static async Task DapperListSupport(IDbConnection db)
{
...
static async Task ReturnSingleRecord(IDbConnection db)
{
...
static async Task ReturnParameters(IDbConnection db)
{
...
static async Task OutputParameters(IDbConnection db)
{
